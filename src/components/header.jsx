                                                            ...
                                                            >
                                                                <div className="py-1">
                                                                    {item.dropdown.map((dropdownItem) => (
                                                                        <motion.div key={dropdownItem.name} variants={dropdownItemVariants}>
                                                                            <Link
                    ...
                    {isOpen && (
                        ...
                        >
                            {navItems.map((item, index) => (
                                <motion.div key={item.name} variants={mobileItemVariants} className="py-2">
                                    {item.dropdown ? (
                                        <motion.button
                                        ...
                                        <Link href={item.href} className="block text-gray-300 hover:text-white py-2">
                                            {item.name}
                                        </Link>
                                    )}
                                            ...
                                            >
                                                {item.dropdown?.map((dropdownItem) => (
                                                    <motion.div
                                                        ...
                                                        transition={{ duration: 0.2 }}
                                                    >
                                                        <Link href={dropdownItem.href} className="block text-gray-400 hover:text-white py-1">
                                                            {dropdownItem.name}
                                                        </Link>
                                                    </motion.div>
                                                ))}
